...
describe("room-scoped public API client", () => {
  test("builds room-scoped URLs for prompts/jobs/gallery", async () => {
    fetchMock
    ...
    await getRoomJobStatus("room-a", "abc123hash");
    ...
    expect(fetchMock).toHaveBeenNthCalledWith(3, expect.stringContaining("/api/rooms/room-a/jobs/hash/abc123hash"));
