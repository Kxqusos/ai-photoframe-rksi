...
from photoframe_backend.api.http.security import require_admin, require_room_access
...
RoomAccessSlug = Annotated[str, Depends(require_room_access)]
PublicIdPath = Annotated[str, FastapiPath(pattern=PUBLIC_ID_PATTERN)]

__all__ = ["AdminUsername", "DbSession", "PublicIdPath", "RoomAccessSlug", "get_db", "require_admin", "require_room_access"]
